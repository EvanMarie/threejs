...
var NavLink2 = React3.forwardRef(({
  ...
  return React3.createElement(React3.Fragment, null, React3.createElement(NavLink, _extends3({}, props, prefetchHandlers, {
...
var Link2 = React3.forwardRef(({
  ...
  let href = useHref(to);
  let [shouldPrefetch, ref, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return React3.createElement(React3.Fragment, null, React3.createElement(Link, _extends3({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to
  })), shouldPrefetch && !isAbsolute ? React3.createElement(PrefetchPageLinks, {
    page: href
...
function Links() {
  ...
  return React3.createElement(React3.Fragment, null, criticalCss ? React3.createElement("style", {
    ...
    key,
    link
  }) => isPageLinkDescriptor(link) ? React3.createElement(PrefetchPageLinks, _extends3({
    key
  }, link)) : React3.createElement("link", _extends3({
    key
  }, link))));
}
function PrefetchPageLinks({
  ...
  return React3.createElement(PrefetchPageLinksImpl, _extends3({
    page,
    matches
  }, dataLinkProps));
}
...
function PrefetchPageLinksImpl({
  ...
  return React3.createElement(React3.Fragment, null, dataHrefs.map((href) => React3.createElement("link", _extends3({
    key: href,
    rel: "prefetch",
    as: "fetch",
    href
  }, linkProps))), moduleHrefs.map((href) => React3.createElement("link", _extends3({
    key: href,
    rel: "modulepreload",
    href
    ...
    React3.createElement("link", _extends3({
      key
    }, link))
  )));
}
function Meta() {
  ...
  return React3.createElement(React3.Fragment, null, meta.flat().map((metaProps) => {
    ...
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return React3.createElement(Comp, _extends3({
    ...
    return React3.createElement("meta", _extends3({
...
import(${JSON.stringify(manifest.entry.module)});`;
    return React3.createElement(React3.Fragment, null, React3.createElement("script", _extends3({}, props, {
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: createHtml(contextScript),
      type: void 0
    })), React3.createElement("script", _extends3({}, props, {
      suppressHydrationWarning: true,
...
function DeferredHydrationScript({
  ...
  return React3.createElement(React3.Suspense, {
    fallback: (
      ...
      typeof document === "undefined" && deferredData && dataKey && routeId ? null : React3.createElement("script", _extends3({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: " "
    ...
    children: (data) => {
      return React3.createElement("script", _extends3({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
  ...
  }) : React3.createElement("script", _extends3({}, scriptProps, {
    async: true,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
      __html: " "
...
function BoundaryShell({
  ...
  }), React4.createElement("title", null, title)), React4.createElement("body", null, children, React4.createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
              console.log(
...
function RemixRootDefaultHydrateFallback() {
  return React5.createElement("html", {
    lang: "en"
  }, React5.createElement("head", null, React5.createElement("meta", {
    charSet: "utf-8"
  }), React5.createElement("meta", {
    name: "viewport",
    content: "width=device-width,initial-scale=1,viewport-fit=cover"
  })), React5.createElement("body", null, React5.createElement(Scripts, null), React5.createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
              console.log(
...
function createServerRoutes(manifest, routeModules, future, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), spaModeLazyPromise = Promise.resolve({
  ...
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    let dataRoute = {
      ...
      ErrorBoundary: routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => React6.createElement(RemixRootDefaultErrorBoundary, {
        error: useRouteError()
      }) : void 0,
      id: route.id,
      index: route.index,
...
function ScrollRestoration2({
  ...
  return React8.createElement("script", _extends3({}, props, {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CNWJTNW5.js.map
